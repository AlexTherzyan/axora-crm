    ...
    <form class="js-validation-recovery-form" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-sm-6">
                <button name="password_remind" type="submit" class="btn btn-block btn-info">Выслать</button>
            </div>
            <div class="form-group col-sm-6">
                <button type="button" class="btn btn-block btn-outline-secondary js-popup-open-login" data-type="ajax" data-src="ajax/login-window.php">Войти</button>
            </div>
        </div>
    </form>
</div>
